$(document).on('ready', function () {
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           $("#formulario1").append("<img src='Archivos/Formatos/imagen.png' style='margin-left: 14%;' id='formato'></img>");    
           if(jsondata[formato]==("documento"))
           $("#formulario1").append("<img src='Archivos/Formatos/documento.png' style='margin-left: 14%;' id='formato'></img>");
           if(jsondata[formato]==("video"))
           $("#formulario1").append("<img src='Archivos/Formatos/video.png'  style='margin-left: 14%;' id='formato'></img>");
              if(jsondata[formato]==("audio"))
              $("#formulario1").append("<img src='Archivos/Formatos/audio.png'  style='margin-left: 14%;' id='formato'></img>");      
